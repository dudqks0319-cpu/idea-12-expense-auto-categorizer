...
import 'package:app_12_expense_auto_categorizer/app.dart';
import 'package:app_12_expense_auto_categorizer/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('지출 자동 분류 가계부'), findsWidgets);
